    ...
    <section id="project">
      <div className="projects-section-content-box">
        ...
        <div className="project--section--links">
            ...
            <a href="https://github.com/perarulalan15/chronic-kidney-disease" className="project--section--links-1">View In Github <svg className="project-svg" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#30D85B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-up-right"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg></a>
            <a href="https://github.com/perarulalan15/customer-churn-prediction" className="project--section--links-1">View In Github <svg className="project-svg" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#30D85B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-up-right"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg></a>
        </div>
      </div>
    </section>
  );
